...
4. **Detect routing.** Check whether the note matches any of the following destinations. Multiple can apply — route to all that match. If none apply, skip routing.
   ...
   - Lindy → `/Users/nlehrer/Desktop/life-os/work/messenger-intl/director-of-video-production/1on1s/lindy-wood/one-on-one-documents/running-notes.md`
   - Andrew → `/Users/nlehrer/Desktop/life-os/work/messenger-intl/director-of-video-production/1on1s/andrew-mcintosh/one-on-one-documents/running-notes.md`
