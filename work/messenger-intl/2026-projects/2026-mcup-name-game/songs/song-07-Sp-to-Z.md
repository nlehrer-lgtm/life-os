...
song: 7 of 7
range: Spell → Zwanziger
genre: Bluegrass / Americana
length_target: ≤ 70 seconds (slightly longer to land the closer)
individuals: 30
created: 2026-06-11
---
...
[Fiddle + banjo intro — fast pickin']
...
- **Spell:** Ben & Corley, Bear, Daisy, Scout, Wilder
- **Stamps:** Bradley, Ivy, Mia, Molly
- **Stansberry:** Alison, Isaiah
- **Turkington:** Lynton & Judy
- **Unclebach:** Scott & Darlene
- **Weaver:** Lin & Bernice, Bransen
- **Wells:** Lyle & Ronda
- **West:** JP, John
- **Wiggs:** Landon, Valerie Biswas
- **Winstead:** Jordie
- **Ynfante:** Crislenny
- **Zimmerman:** Caleb
- **Zwanziger:** Cohen, Joseph

## Gemini style prompt

> High-energy bluegrass / Americana in the spirit of Old Crow Medicine Show and the Punch Brothers. ~150 BPM, breakneck pickin' tempo. Driving acoustic guitar, three-finger banjo roll, fiddle lead, mandolin chops on the 2 and 4, slap upright bass. Lead male tenor with a hearty country twang, harmony stack on the chorus. Joyful, foot-stomping, celebratory — this is the finale of a seven-song memorization series, so end big with a final hook that lands the punchline "131 names." Length: 60–70 seconds (slightly longer to fit the closer). Names sung clearly and snappily on the beat.
...
- This is the finale — give it the most energy and the biggest payoff on the final chorus.
- Two Wests (JP and John) and two Spells named with "S" sounds (Scout, Spell) — keep diction sharp.
- "Ynfante" = "in-FAHN-tay" — Spanish-origin. If Gemini muddles, regenerate.
- "Zwanziger" = "ZWAN-zi-ger" — German.
- "Crislenny" is unusual — if Gemini falters, try the phonetic spelling "Cris-Lenny" in the lyric.
