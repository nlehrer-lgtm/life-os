---
name: messenger-studios-stage-build-manual
description: Step-by-step construction manual for building the permanent modular production stage at Messenger Studios. Written for a team without carpentry experience. Uses only the materials in the original blueprint BOM (fastener-only, no glue). All measurements verified.
aliases:
  - Stage Build Manual
  - Stage Construction Manual
  - Permanent Stage Build Guide
  - How to Build the Stage
metadata:
  type: reference
  source: "messenger-studios-stage-blueprint.svg (REV 0) + messenger-studios-stage-materials-quote.md"
...
**A step-by-step guide for building the 15-panel modular production stage that sits in front of the curved [[messenger-studios-led-wall|LED wall]].**

Written so that anyone on the [[Video Team]] can build it — no prior carpentry experience assumed. Every measurement here has been double-checked against the [stage blueprint](messenger-studios-stage-blueprint.svg). Build it **fastener-only** (screws, bolts, nails, dowels) — there is no glue in this build, which keeps every panel removable and serviceable.
...
A **20-foot-wide stage**, **7 inches tall**, made of **15 separate panels** that bolt together. Ten panels are plain 4'×4' squares. Five panels (the back row, against the LED wall) have a curved back edge so the stage hugs the wall's curve.
...
![[stage-build-fig1-deck-section.svg]]
*Figure 1 — Cross-section of one panel. Bottom to top: leveler foot, 2x6 frame, ¾" plywood deck, ¼" Masonite top = 7" total.*

---

## ⚠️ Safety first (read before every work session)
...
![[stage-build-fig4-assembly-plan.svg]]
...
| Side rail | **45"** | 2 | Fits *between* the front & back rails |
...
![[stage-build-fig2-standard-panel-frame.svg]]
...
2. Set the two **45" side rails** *between* them, flush to the ends, forming a 48"×48" square box.
3. At each corner, drive **3× #8 × 3" screws** through the 48" rail into the end of the 45" rail. Pre-drill near the ends so the wood doesn't split.
4. Check the box is square: measure both diagonals corner-to-corner. **They must be equal** (≈67⅞"). Adjust until they match, then it's square.
...
3. Screw each tunnel rail to the front and back rails: **3× #8 × 3"** at each end.
...
2. Screw through the side rail and the tunnel rail into each end: **2× #8 × 3"** per end.

### Step 5.4 — Lay the deck

1. Set a **48"×48" × ¾" plywood** square on top. It should sit flush to all outside edges.
2. Screw it down with **#8 × 3"** screws, **countersunk flush**, every **8"** around the perimeter and along the tunnel rails and blocking. *(Flush heads matter — the Masonite skin must lie flat on top.)*
3. **Do not** put screws over the open 6" tunnel.

### Step 5.5 — Add the Masonite top skin

1. Lay a **48"×48" × ¼" Masonite** square, smooth side **up**, on the deck.
2. Fasten with **#6 × ⅝" finish nails**: every **6"** around the edges, every **12"** in the field. Set the heads just below the surface.

### Step 5.6 — Mount the leveler feet

1. Flip the panel upside down.
2. At each corner, screw a **5½" corner block** flat into the inside corner with **2–3× #8 × 1¼"** screws. This gives solid wood for the foot.
...
![[stage-build-fig3-curved-panel-marking.svg]]
...
|---|---|---|---|---|---|---|---|---|---|
| Depth | 46¹¹⁄₁₆" | 47¼" | 47¹¹⁄₁₆" | 47¹⁵⁄₁₆" | 48" | 47¹⁵⁄₁₆" | 47¹¹⁄₁₆" | 47¼" | 46¹¹⁄₁₆" |

**Panels B3 & D3** — D3 is the mirror of B3. Put **u = 0 at the edge facing the center** of the stage:

| u (across) | 0" | 6" | 12" | 18" | 24" | 30" | 36" | 42" | 48" |
|---|---|---|---|---|---|---|---|---|---|
| Depth | 46¹¹⁄₁₆" | 45¹⁵⁄₁₆" | 45" | 43¹⁵⁄₁₆" | 42⅝" | 41³⁄₁₆" | 39⁹⁄₁₆" | 37¾" | 35¾" |

**Panels A3 & E3 (wings)** — E3 is the mirror of A3. Put **u = 0 at the edge facing the center** of the stage:

| u (across) | 0" | 6" | 12" | 18" | 24" | 30" | 36" | 42" | 48" |
|---|---|---|---|---|---|---|---|---|---|
| Depth | 35¾" | 33⁹⁄₁₆" | 31³⁄₁₆" | 28⁹⁄₁₆" | 25¾" | 22¹¹⁄₁₆" | 19⅜" | 15¹³⁄₁₆" | 12" |

> **Sanity check before cutting:** Lay B3 next to C3 the way they'll sit on stage. The depth where they meet should match — C3's edge reads **46¹¹⁄₁₆"** and B3's inner edge reads **46¹¹⁄₁₆"**. Same for B3↔A3 at **35¾"**. If neighboring edges match, your curve is continuous. ✅
...
1. Lay a ¼" Masonite square on the curved panel and trace the curved edge from below; cut the skin to match with the jigsaw.
...
1. Where two panels meet, drill **¼" holes ~2" deep** into the mating rail faces, **2 holes per seam** (about 6" in from each end), lined up across the seam.
2. Tap a **¼" × 2" dowel pin** halfway into one panel; the neighbor slips onto it. Dowels keep the tops perfectly flush at the seam.

### Step 8.3 — Bolt panels together

![[stage-build-fig5-joint-detail.svg]]
*Figure 5 — A bolted seam: dowel pin for alignment, ⅜" carriage bolt + washer + wing nut to clamp.*

1. Along each seam, drill **⅜" holes** through both mating rails, placed **6" from each end and every 12" between** (a full 48" seam gets **4 bolts**; shorter curved-row seams get 3).
2. Push a **⅜" × 4" carriage bolt** through, add a **washer + wing nut** on the far side, and tighten snug with the wrench. The square shoulder under the carriage-bolt head bites the wood so it won't spin.
3. **Avoid the tunnel:** keep bolts clear of the 6" center notch (the 18" and 30" positions sit just outside it — good).

**Bolt count check:** 5 front-row + 5 mid-row column seams, 8 between-row seams, plus curved-row seams ≈ **86 bolts** used. The plan's ~180 leaves a big spare margin.

### Step 8.4 — Level the whole stage

1. With everything bolted, put a level on top across multiple seams.
2. Adjust the **leveler feet** up or down (¾" stud, ½"–1½" range) until the entire 20' top is flat and seams are flush. Start from the highest corner and work out.
...
2. In each skirt piece, cut a **8" wide × 4" tall** door opening, **centered**, lined up with that column's cable tunnel. Keep the cut-out piece — that's the door.
3. Mount each skirt section to the **downstage front rail** with **#8 × 1¼"** screws, every 12".
...
> **Power check:** 7 m of 60-LED/m RGBW pulls roughly 130 W at full white — the **200 W** supply runs it at about ⅔ load. Good headroom. ✅
...
| Check | Result |
|---|---|
| Deck stack height | ¼" + ¾" + 5½" + ½" leveler = **7.0"** ✅ |
| Grid width | 5 × 48" = 240" = **20'-0"** ✅ |
| Depth at center | 3 × 48" = 144" = **12'-0"** ✅ |
| Curve radius (R) | **218"** — gives center 144" & wings 108" exactly ✅ (blueprint's 217.85" was rounding) |
| Depth formula | depth = √(47,524 − x²) − 170, x = inches from center |
| Depth at wings | √(47,524 − 120²) − 74 = **108" = 9'-0"** ✅ |
| Cable tunnel | 6" clear between tunnel rails (at 21"–27"); 6"×4" notch in rails ✅ |
| Side bays | 18" clear each — fine for ¾" ply deck span ✅ |
| Neighbor-edge depths | B3↔C3 match at 46¹¹⁄₁₆"; A3↔B3 match at 35¾" → curve is continuous ✅ |
| LED power | 7 m RGBW ≈ 130 W on a 200 W supply ✅ |
