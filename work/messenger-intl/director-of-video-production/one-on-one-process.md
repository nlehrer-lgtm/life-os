...
In the downward 1:1, **[[Lindy Wood|Lindy]]/[[Andrew McIntosh|Andrew]] drive the agenda and Nathaniel brings context.** In the upward 1:1, **Nathaniel drives the agenda and [[Arden Bevere|Arden]] brings context.** Same framework, different seat.
...
This step applies equally to [[Lindy Wood|Lindy]], [[Andrew McIntosh|Andrew]], and [[Arden Bevere|Arden]] 1:1s.
...
Whenever you notice something about [[Lindy Wood|Lindy]] or [[Andrew McIntosh|Andrew]], capture it with `/note`:

> `/note for Lindy: she nailed the AACC pilot edit pacing today`

The `/note` skill writes to `notes/inbox.md` *and* (because it detected "[[Lindy Wood|Lindy]]") to `work/messenger-intl/director-of-video-production/1on1s/lindy-wood/running-notes.md`. Same for [[Andrew McIntosh|Andrew]].
...
- **[[Lindy Wood|Lindy]]'s task** is due Fridays at 2:30pm CT (3 weekdays before Tue 2:30pm).
- **[[Andrew McIntosh|Andrew]]'s task** is due Mondays at 1:30pm CT (3 weekdays before Thu 1:30pm).
...
You run `/1on1-prep Lindy` (or [[Andrew McIntosh|Andrew]]).
...
- **"Run /1on1-debrief [[Lindy Wood|Lindy]]"** — due Wed (day after Tue 1:1)
- **"Run /1on1-debrief [[Andrew McIntosh|Andrew]]"** — due Fri (day after Thu 1:1)

You run `/1on1-debrief Lindy` (or [[Andrew McIntosh|Andrew]]). The skill:
...
|---|---|---|
| Between meetings | `/note` | `notes/inbox.md` + their `running-notes.md` (if [[Lindy Wood|Lindy]] or [[Andrew McIntosh|Andrew]] named) |
...
- **[[Lindy Wood|Lindy]]'s growth plan (Asana):** `Lindy W - Growth Plan` — recurring agenda task lives here
- **[[Andrew McIntosh|Andrew]]'s growth plan (Asana):** `Andrew M - Growth Plan` — recurring agenda task lives here
...
- **Life OS markdown:** `work/messenger-intl/director-of-video-production/1on1s/{lindy-wood,andrew-mcintosh}/` — prep, final, summary, running notes
...
In this loop, **Nathaniel is the team member.** [[Arden Bevere|Arden]] is the leader. Per the framework, Nathaniel owns the agenda; [[Arden Bevere|Arden]] brings context (vision, direction, content/discipleship strategy, role alignment).

### Phase 1 — Between meetings
Whenever something surfaces that you want to raise with [[Arden Bevere|Arden]], capture it. Two ways:

- Edit `work/messenger-intl/director-of-video-production/1on1s/arden-bevere/running-notes.md` directly with a quick bullet
...
The skill pulls:
- Your running notes for [[Arden Bevere|Arden]]
- "[[Arden Bevere|Arden]]" mentions in `notes/inbox.md`
- Video team CONTEXT.md / STATUS.md (and discipleship team equivalents when those exist)
- Latest [[Lindy Wood|Lindy]] and [[Andrew McIntosh|Andrew]] 1:1 summaries — so you can report up on how the team is doing
- Recent journal entries and digests (last 7 days)
- The most recent prior [[Arden Bevere|Arden]] 1:1 prep + summary (for continuity)
- Granola transcript if a folder ID is configured (currently not — to be added when you start recording)

It writes a prep doc with: personal check-in, top priorities to bring, progress since last 1:1, current challenges, wins to name, **strategic questions for [[Arden Bevere|Arden]]** (vision & direction, video team state, discipleship team state, leadership / coaching), open items from last cycle, and ad-hoc notes verbatim.
...
You run `/1on1-final-arden`. It reads the adjusted prep, asks what you most want to land, and produces a one-page glance sheet structured around what YOU will bring: open with (personal), bring these (priorities), wins to name, ask [[Arden Bevere|Arden]] (questions in priority order), if time.

### Phase 4 — The 1:1 itself
- **You drive the agenda.**
- **[[Arden Bevere|Arden]] brings context** — vision, content/discipleship strategy, priority calls, role alignment.
- People-first: care → clarity → direction.
...
- Saves a summary to `work/messenger-intl/director-of-video-production/1on1s/arden-bevere/1on1-summary-YYYY-MM-DD.md` (uses the **meeting date**, not today)
...
You reply with numbers (or `all` / `none`). Your items land in your My Tasks; [[Arden Bevere|Arden]]'s items become `[Follow up with Arden]` reminders in your My Tasks (until a different Asana pattern is configured for him).
...
| When | Tool | Where output lives |
|---|---|---|
| Between meetings | manual edits to `running-notes.md` (or future `/note for Arden`) | `work/messenger-intl/director-of-video-production/1on1s/arden-bevere/running-notes.md` |
| A couple days before | `/1on1-prep-arden` | `work/messenger-intl/director-of-video-production/1on1s/arden-bevere/1on1-prep-YYYY-MM-DD.md` |
| Morning of | `/1on1-final-arden` | `work/messenger-intl/director-of-video-production/1on1s/arden-bevere/1on1-final-YYYY-MM-DD.md` |
...
- **Capture a note:** edit `work/messenger-intl/director-of-video-production/1on1s/arden-bevere/running-notes.md` directly (or `/note for Arden: <thing>` once routing is added)
...
- **Leadership development on the video team** — pulling the gold out of [[Lindy Wood|Lindy]] and [[Andrew McIntosh|Andrew]]; creating new leaders. This is the most consistent through-line of conversations with [[Arden Bevere|Arden]].
